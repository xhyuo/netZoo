...
#'
#' @param col Numerical Vector indicating the index (0-based)of specified sample in a population. 
...
#' @import reticulate
#' @export
plotLioness <- function(col = column, top = top_wgt_num, file = file_name){
